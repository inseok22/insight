...
// src/pages/sub_pages/VllmObservability.tsx
import { useEffect, useState, useRef } from 'react';
import { Spin, Result, Button } from 'antd';



export default function VllmObservability() {
    const EXTERNAL_URL = useFrontendConfig().dashboards["vllm_observability_url"] || undefined;
